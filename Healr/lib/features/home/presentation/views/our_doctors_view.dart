...
import 'package:healr/features/home/presentation/views/widgets/our_doctors_view_body.dart';

class OurDoctorsView extends StatelessWidget {
  const OurDoctorsView({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => GetDoctorsCubit(getIt.get<GetDoctorsRepoImp>()),
      child: const OurDoctorsViewBody(),
    );
  }
}
